...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| image.imageTagWithPrefixAndQuotes | string | `"ghcr.io/chrisjburns/release-flow-test:v0.12.0"` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"ghcr.io/chrisjburns/release-flow-test"` |  |
| image.tag | string | `"0.12.0"` |  |
| image.tagUnquoted | string | `"0.12.0"` |  |
| image.tagWithPrefixAndQuotes | string | `"v0.12.0"` |  |
| image.tagWithPrefixAndUnquoted | string | `"v0.12.0"` |  |
